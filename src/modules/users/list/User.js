...
export function User(props) {
    return <div className="uk-grid uk-child-width-1-2@s uk-child-width-1-2@m">
                            ...
                            <div className="uk-card-header">
                                <div className="uk-grid-small uk-flex-middle">
                                    <div className="uk-width-auto">
                                        <img className="uk-border-circle" alt="users" width="40" height="40" src="https://picsum.photos/400/400" />
                                    </div>
